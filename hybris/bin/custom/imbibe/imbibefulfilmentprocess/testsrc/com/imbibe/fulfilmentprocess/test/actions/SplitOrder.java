 ...
 */
package com.imbibe.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ImbibeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ImbibeFulfilmentProcessConstants.PARENT_PROCESS);
