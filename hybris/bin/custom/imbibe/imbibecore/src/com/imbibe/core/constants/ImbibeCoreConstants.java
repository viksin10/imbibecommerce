 ...
 */
package com.imbibe.core.constants;

/**
 * Global class for all ImbibeCore constants. You can add global constants for your extension into this class.
 */
public final class ImbibeCoreConstants extends GeneratedImbibeCoreConstants
{
	public static final String EXTENSIONNAME = "imbibecore";


	private ImbibeCoreConstants()
	{
		//empty
	}
