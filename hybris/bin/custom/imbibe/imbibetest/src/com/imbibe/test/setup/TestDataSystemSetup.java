...
import com.imbibe.test.constants.ImbibeTestConstants;
import com.imbibe.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ImbibeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/imbibetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/imbibetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/imbibetest/import/cstickets.impex");
			...
			importImpexFile(context, "/imbibetest/import/csquotes.impex");
		}
	}
}
